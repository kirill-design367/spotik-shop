...
export default function RevealRoot() {
  useEffect(() => {
    ...
    // где рождаются триггер скролла и Lenis, — значит удлинить и без того
    // самый дорогой кадр страницы. Замерено: рывок первого колеса на
    // холодной загрузке 0.62 px против 0.04, а прокрутка уезжала на 26 px
    // и возвращалась. Ждать не страшно: все строки лежат ниже первого
    // экрана, увидеть их за один кадр нельзя.
