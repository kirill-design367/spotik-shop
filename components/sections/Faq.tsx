...
const QA = [
  {
    q: 'Нужен ли VPN?',
    a: 'ЗАГЛУШКА. Здесь будет ответ про то, что VPN не требуется ни для оплаты, ни для прослушивания, и что настройки сети менять не нужно. Две-три строки.',
  },
  {
    q: 'Как оплатить из России?',
    a: 'ЗАГЛУШКА. Здесь будет ответ про оплату российской картой и через СБП, без зарубежных карт и посредников. Две-три строки.',
  },
  {
    q: 'Что если аккаунт перестанет работать?',
    a: 'ЗАГЛУШКА. Здесь будет ответ про то, что делает сервис, если доступ прервался раньше срока, и в какой срок вопрос решается. Формулировка за арт-директором — это обязательство перед клиентом.',
  },
  {
    q: 'Можно ли слушать с нескольких устройств?',
    a: 'ЗАГЛУШКА. Здесь будет ответ про число одновременных устройств и про то, чем тарифы на двоих и на троих отличаются от индивидуального. Две-три строки.',
  },
  {
    q: 'Сколько ждать после оплаты?',
    a: 'ЗАГЛУШКА. Здесь будет ответ про фактическое время от оплаты до выдачи доступа и про то, что происходит, если оно вышло за обычные рамки. Две-три строки.',
  },
  {
    q: 'Что если я передумаю?',
    a: 'ЗАГЛУШКА. Здесь будет ответ про возврат: в какой срок, на каких условиях и каким способом приходят деньги. Формулировка за арт-директором — это обязательство перед клиентом.',
  },
];
