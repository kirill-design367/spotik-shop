        ...
        <div style={{ gridColumn: 'span 4' }}>
          ...
          <dl className="footer__req">
            ...
            <dd>
              ...
              */}
              {/* Без прозрачности: на зелёном она роняет контраст ниже нормы
                  (0.72 давало 4.47:1 при пороге 4.5). Второстепенность
                  передаём словом, а не яркостью. */}
              <span>Публичная оферта — готовится</span>
            </dd>
          </dl>
        </div>
