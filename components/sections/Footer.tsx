 ...
 * его НИЗ прибит к линии, где кончается слой, и оттуда слово растёт ВВЕРХ.
 * Реквизиты держат низ экрана и не двигаются.
 *
 * Ход читается сам: секция выезжает снизу обычным скроллом со сжатым
 * словом → низ чернил приходит на свою линию и прибивается (это тот же
 * кадр, в котором сцена прилипает) → с этого кадра скролл растягивает
 * слово вверх → слово упёрлось в верхнюю границу зелёного поля и получило
 * срез → выезжают реквизиты.
 *
